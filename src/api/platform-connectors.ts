...
router.get('/chatgpt-connector', (req: Request, res: Response) => {
  ...
  res.json({
    ...
    info: {
      ...
      version: '2.0.0',
      description:
        '1000x Enhanced MCP Server with Universal Platform Support - WebContainer Development Environment with Advanced Tools',
      contact: {
...
router.get('/vscode-connector', (req: Request, res: Response) => {
  ...
  res.json({
    ...
    activation_events: ['onStartupFinished', 'onCommand:disco-mcp.connect', 'onLanguage:*'],
  });
});
...
router.get('/cursor-connector', (req: Request, res: Response) => {
  ...
  res.json({
    cursor_mcp_config: {
      ...
      version: '2.0.0',
      description:
        'Ultimate MCP Server for Cursor Composer - 1000x Enhanced Development Experience',
      transport: {
        stdio: {
          command: 'npx',
...
router.get('/jetbrains-connector', (req: Request, res: Response) => {
  ...
  res.json({
    jetbrains_plugin_config: {
      ...
      version: '2.0.0',
      description:
        'Ultimate MCP Integration for JetBrains IDEs - Enhanced AI Development Assistant',
      compatibility: {
        intellij: '2023.1+',
        pycharm: '2023.1+',
        webstorm: '2023.1+',
...
router.get('/zed-connector', (req: Request, res: Response) => {
  ...
  res.json({
    zed_extension_config: {
      ...
      version: '2.0.0',
      description:
        'Ultimate MCP Integration for Zed Editor - High-Performance AI Development Assistant',
      schema_version: 1,
      mcp_integration: {
        transport: 'stdio',
        server: {
