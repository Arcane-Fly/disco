...
export const Toast: React.FC<ToastProps> = ({
  ...
  return (
    <div
      className={clsx(
        'flex items-start p-4 mb-4 border-l-4 rounded-r-lg shadow-lg transition-all duration-300',
        'animate-slide-in',
        typeStyles[type]
      )}
      role="alert"
    ...
    >
      ...
      <button
        onClick={() => onClose(id)}
        className="ml-4 flex-shrink-0 inline-flex text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
        aria-label="Close"
      >
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
