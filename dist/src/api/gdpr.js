 ...
 */
router.get('/export/:userId', authMiddleware, [param('userId').isString().trim().notEmpty()], async (req, res) => {
    ...
    if (requestingUser !== userId && !req.user?.admin) {
 ...
 */
router.post('/restrict/:userId', authMiddleware, [
    param('userId').isString().trim().notEmpty(),
...
// Helper functions
async function getAuditLogs(_userId, _days) {
    // Implementation would fetch from actual audit log storage
    return [];
}
async function deleteAuditLogs(_userId) {
    // Implementation would delete from actual audit log storage
}
async function getApiUsageStats(_userId) {
...
async function deleteApiUsageStats(_userId) {
    // Implementation would delete from metrics storage
}
async function getFileMetadata(_userId) {
    // Implementation would fetch file metadata
    return [];
}
async function getUserPreferences(_userId) {
    // Implementation would fetch user preferences
    return {};
}
async function deleteUserPreferences(_userId) {
    // Implementation would delete user preferences
}
async function restrictProcessing(_userId, _categories, _reason) {
    // Implementation would restrict processing for specified categories
}
function generateDeletionCertificate(report) {
...
async function logDeletion(report) {
