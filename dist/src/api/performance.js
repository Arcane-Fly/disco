 ...
 *         description: Internal server error
 */
router.post('/usage-patterns', authMiddleware, async (req, res) => {
    try {
 ...
 *         description: Internal server error
 */
router.post('/scaling/analyze', authMiddleware, async (req, res) => {
    try {
 ...
 *         description: Internal server error
 */
router.post('/prewarming/analyze', authMiddleware, async (req, res) => {
    try {
 ...
 */
router.post('/container/priority', authMiddleware, async (req, res) => {
    try {
