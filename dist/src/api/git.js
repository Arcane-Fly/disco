...
router.post('/:containerId/clone', async (req, res) => {
    try {
        ...
        const { url, branch, authToken, directory } = req.body;
 ...
 */
router.post('/:containerId/commit', async (req, res) => {
    try {
        const { containerId } = req.params;
 ...
 */
router.post('/:containerId/push', async (req, res) => {
    try {
        const { containerId } = req.params;
        const { remote = 'origin', branch = 'main', authToken, force } = req.body;
        const userId = req.user.userId;
 ...
 */
router.post('/:containerId/pull', async (req, res) => {
    try {
        const { containerId } = req.params;
 ...
 * Get commit history
 */
router.get('/:containerId/log', async (req, res) => {
    try {
        const { containerId } = req.params;
...
async function cloneRepository(container, options) {
    try {
...
async function commitChanges(container, options) {
    try {
...
async function pushChanges(container, options) {
    try {
...
async function getRemoteUrl(container, remote = 'origin') {
    try {
...
async function pullChanges(container, options) {
    try {
...
async function getGitStatus(container) {
    try {
...
async function getGitLog(container, options) {
    try {
