...
router.get('/chatgpt-connector', (req, res) => {
...
router.get('/claude-connector', (req, res) => {
    const baseUrl = `${req.protocol}://${req.get('host')}`;
    res.json({
...
router.get('/vscode-connector', (req, res) => {
    const baseUrl = `${req.protocol}://${req.get('host')}`;
    res.json({
...
router.get('/cursor-connector', (req, res) => {
    const baseUrl = `${req.protocol}://${req.get('host')}`;
    res.json({
        cursor_mcp_config: {
            name: 'disco-mcp-ultimate',
...
router.get('/warp-connector', (req, res) => {
    const baseUrl = `${req.protocol}://${req.get('host')}`;
    res.json({
...
router.get('/jetbrains-connector', (req, res) => {
    const baseUrl = `${req.protocol}://${req.get('host')}`;
    res.json({
...
router.get('/zed-connector', (req, res) => {
    const baseUrl = `${req.protocol}://${req.get('host')}`;
    res.json({
...
//# sourceMappingURL=platform-connectors.js.map