 ...
 *                         type: integer
 */
router.get('/:containerId/sessions', authMiddleware, async (req, res) => {
    try {
 ...
 */
router.post('/:containerId/broadcast', authMiddleware, async (req, res) => {
    try {
        const { containerId } = req.params;
 ...
 */
router.post('/:containerId/sync', authMiddleware, async (req, res) => {
    try {
        const { containerId } = req.params;
        ...
        await collaborationManager.syncFileToCollaborators(containerId, filePath, content, excludeUserId);
 ...
 *                     type: string
 */
router.get('/session/:sessionId/users', authMiddleware, async (req, res) => {
    try {
 ...
 */
router.post('/session/:sessionId/resolve-conflict', authMiddleware, async (req, res) => {
    try {
        const { sessionId } = req.params;
        ...
        const result = await collaborationManager.resolveManualConflict(sessionId, resolvedContent, strategy, userId);
        res.json({
            success: true,
