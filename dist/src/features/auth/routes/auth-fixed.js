...
import { asyncHandler, createSuccessResponse, sendAuthenticationError, sendValidationError, sendInternalError, } from '../../shared/types/express';
const router = Router();
 ...
 */
const githubAuthHandler = async (req, res) => {
    try {
